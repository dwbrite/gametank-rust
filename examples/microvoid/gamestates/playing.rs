...
use crate::gamer::*;
use gt_crust::system::position::{f16u8_to_u8, FancyPosition, fu16u8_to_u8, ScreenSpacePosition, SubpixelFancyPosition};
...
impl GameState for Playing {
    fn update_and_draw(mut self, ticks: u64, console: &mut Console) -> GameStates {
        ...
        //
        self.minifont.draw_number(console, 1, 0, self.score, fu16u8_to_u8(self.silly_digits));
