...
// dgtf_macros::include_spritesheet!(TITLE_SPRITES, "examples/microvoid/assets/title.bmp", "examples/microvoid/assets/title.json");
...
// pub fn load_title_sprite(console: &mut Console) {
//     let sprite_sheet = &TITLE_SPRITES;
//
//     let vram = console.access_vram_bank(0, &SpriteRamQuadrant::Three);
//
//     let bits_per_pixel = 8 / sprite_sheet.pixels_per_byte as usize;
//     let mask = (1 << bits_per_pixel) - 1;
//
